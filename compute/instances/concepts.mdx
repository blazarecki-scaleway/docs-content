...
[Production-Optimized Instances](https://www.scaleway.com/en/production-optimized-instances/) (aka POP2) are compute resources with dedicated resources (RAM and vCPUs). They are designed for demanding applications, high-traffic databases and production workloads.
